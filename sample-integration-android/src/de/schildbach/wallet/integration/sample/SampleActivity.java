...
import de.schildbach.wallet.integration.android.NubitIntegration;
...
public class SampleActivity extends Activity
{
	...
	private void handleDonate()
	{
		...
		NubitIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, addresses[0]);
	}
	...
	private void handleRequest()
	{
		try
		{
			...
			NubitIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, paymentRequest.build().toByteArray());
		}
	...
	protected void onActivityResult(final int requestCode, final int resultCode, final Intent data)
	{
		if (requestCode == REQUEST_CODE)
		{
			...
			{
				final String txHash = NubitIntegration.transactionHashFromResult(data);
				if (txHash != null)
				{
					...
					if (NubitIntegration.paymentFromResult(data) != null)
