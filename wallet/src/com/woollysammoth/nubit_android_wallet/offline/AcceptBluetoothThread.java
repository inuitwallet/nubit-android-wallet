...
package com.woollysammoth.nubit_android_wallet.offline;
...
import org.nubit.protocols.payments.Protos.PaymentACK;
...
public abstract class AcceptBluetoothThread extends Thread
{
	...
	protected static BluetoothServerSocket listen(final BluetoothAdapter adapter, final UUID uuid)
	{
		try
		{
			return adapter.listenUsingInsecureRfcommWithServiceRecord("Nubit Transaction Submission", uuid);
		}
		catch (final IOException x)
		{
