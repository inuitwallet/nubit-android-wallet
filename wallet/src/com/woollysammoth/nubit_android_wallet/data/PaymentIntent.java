...
package com.woollysammoth.nubit_android_wallet.data;
...
import com.woollysammoth.nubitj.core.WrongNetworkException;
...
public final class PaymentIntent implements Parcelable
{
	...
	public static PaymentIntent fromNubitUri(@Nonnull final NubitURI nubitUri)
	{
		final Output[] outputs = buildSimplePayTo(nubitUri.getAmount(), nubitUri.getAddress());
		final String bluetoothMac = (String) nubitUri.getParameterByName(Bluetooth.MAC_URI_PARAM);

		return new PaymentIntent(PaymentIntent.Standard.BIP21, null, null, null, outputs, nubitUri.getLabel(), bluetoothMac != null ? "bt:"
				+ bluetoothMac : null, null, nubitUri.getPaymentRequestUrl());
	}
