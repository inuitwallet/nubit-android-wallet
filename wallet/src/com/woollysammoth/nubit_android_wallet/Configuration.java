...
public class Configuration
{
	...
	public static final String PREFS_KEY_NBT_PRECISION = "ppc_precision";
	...
	private static final int PREFS_DEFAULT_NBT_PRECISION = 2;
	...
	public int getNBTMaxPrecision()
	{
		...
		if (NBTShift == 0)
			...
			return Constants.MNBT_MAX_PRECISION;
		else
			return Constants.UNBT_MAX_PRECISION;
	}
	...
	public String getNBTPrefix()
	{
		...
		if (NBTShift == 0)
			...
			return Constants.CURRENCY_CODE_MNBT;
		else
			return Constants.CURRENCY_CODE_UNBT;
	}
