...
package com.woollysammoth.nubit_android_wallet;
...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "nubit-wallet-keys";
	public static final String EXTERNAL_WALLET_BACKUP = "nubit-wallet-backup";
	...
	public static final String EXPLORE_BASE_URL = "https://www.nubitexplorer.info/";

	public static final String MIMETYPE_TRANSACTION = "application/x-ppctx";
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-nubit-wallet-backup";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "Nubit Wallet";
	...
	public static final String CURRENCY_CODE_NBT = "NBT";
	public static final String CURRENCY_CODE_MNBT = "mNBT";
	public static final String CURRENCY_CODE_UNBT = "µNBT";
	...
	public static final int NBT_MAX_PRECISION = 6;
	public static final int MNBT_MAX_PRECISION = 3;
	public static final int UNBT_MAX_PRECISION = 0;
	public static final int LOCAL_PRECISION = 4;

	public static final String DONATION_ADDRESS = "PNY8FPHRY8NM8VG77TXZ4R3WY7QJ25ATG6";
	public static final String REPORT_EMAIL = "woollysammoth@thelibertyportal.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/MatthewLM/nubit-android-wallet";
	public static final String BINARY_URL = "https://github.com/MatthewLM/nubit-android-wallet/releases";
	public static final String CREDITS_PEERCOINJ_URL = "https://github.com/MatthewLM/nubitj";
