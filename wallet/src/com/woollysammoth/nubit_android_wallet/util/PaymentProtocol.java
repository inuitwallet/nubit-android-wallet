...
import com.woollysammoth.nubitj.protocols.payments.PaymentSession.PkiVerificationData;
...
{
	public static final String MIMETYPE_PAYMENTREQUEST = "application/nubit-paymentrequest"; // BIP 71
	public static final String MIMETYPE_PAYMENT = "application/nubit-payment"; // BIP 71
	public static final String MIMETYPE_PAYMENTACK = "application/nubit-paymentack"; // BIP 71
			...
			@Nullable final BigInteger refundAmount, @Nullable final String memo, @Nullable final byte[] merchantData)
	{
		...
		builder.addTransactions(ByteString.copyFrom(transaction.unsafeNubitSerialize()));
