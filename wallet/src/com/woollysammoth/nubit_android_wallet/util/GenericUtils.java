...
{
	public static final BigInteger ONE_NBT = new BigInteger("1000000", 10);
	public static final BigInteger ONE_MNBT = new BigInteger("1000", 10);
	public static final BigInteger ONE_UNBT = new BigInteger("1", 10);

	private static final int ONE_NBT_INT = ONE_NBT.intValue();
	private static final int ONE_MNBT_INT = ONE_MNBT.intValue();
	private static final int ONE_UNBT_INT = ONE_UNBT.intValue();
			...
			final int precision, final int shift)
	{
		...
		else if (shift == 3)
		{
			...
			final long absValue = Math.abs(longValue);
			final long coins = absValue / ONE_MNBT_INT;
			final int satoshis = (int) (absValue % ONE_MNBT_INT);
		...
		else if (shift == 6)
		{
			...
			final long absValue = Math.abs(longValue);
			final long coins = absValue / ONE_UNBT_INT;
			final int satoshis = (int) (absValue % ONE_UNBT_INT);
