...
import com.woollysammoth.nubitj.core.TransactionInput;
...
public class WalletUtils
{
	...
	public static BigInteger localValue(@Nonnull final BigInteger NBTValue, @Nonnull final BigInteger rate)
	{
		return NBTValue.multiply(rate).divide(GenericUtils.ONE_NBT);
	}

	public static BigInteger NBTValue(@Nonnull final BigInteger localValue, @Nonnull final BigInteger rate)
	{
		return localValue.multiply(GenericUtils.ONE_NBT).divide(rate);
	}
	...
	public static void writeKeys(@Nonnull final Writer out, @Nonnull final List<ECKey> keys) throws IOException
	{
		...
		out.write("# KEEP YOUR PRIVATE KEYS SAFE! Anyone who can read this can spend your Nubits.\n");
