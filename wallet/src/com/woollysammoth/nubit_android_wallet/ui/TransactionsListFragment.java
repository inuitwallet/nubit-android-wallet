...
import com.woollysammoth.nubitj.core.ScriptException;
import com.woollysammoth.nubitj.core.Transaction;
import com.woollysammoth.nubitj.core.Transaction.Purpose;
...
public class TransactionsListFragment extends SherlockListFragment implements LoaderCallbacks<List<Transaction>>, OnSharedPreferenceChangeListener
{
	...
	private static final Uri KEY_ROTATION_URI = Uri.parse("http://nubit.org/en/alert/2013-08-11-android");
		...
		activity.startActionMode(new ActionMode.Callback()
		{
			...
			public boolean onPrepareActionMode(final ActionMode mode, final Menu menu)
			{
				try
				{
					...
					serializedTx = tx.unsafeNubitSerialize();
	...
	{
		if (Configuration.PREFS_KEY_NBT_PRECISION.equals(key))
			updateView();
	}
	...
	private void updateView()
	{
		...
		adapter.setPrecision(NBTPrecision, NBTShift);
		adapter.clearLabelCache();
	}
}
