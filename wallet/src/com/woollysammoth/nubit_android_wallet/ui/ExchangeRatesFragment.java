...
public final class ExchangeRatesFragment extends SherlockListFragment implements OnSharedPreferenceChangeListener
{
	...
	{
		if (Configuration.PREFS_KEY_EXCHANGE_CURRENCY.equals(key) || Configuration.PREFS_KEY_NBT_PRECISION.equals(key))
		{
			defaultCurrency = config.getExchangeCurrencyCode();
	...
	private void updateView()
	{
		...
		if (adapter != null)
		{
			...
			final BigInteger base = NBTShift == 0 ? GenericUtils.ONE_NBT : GenericUtils.ONE_MNBT;
	...
	{
		private BigInteger rateBase = GenericUtils.ONE_NBT;
